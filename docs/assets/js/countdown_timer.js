var countDownTimer = function(id, date) {
    ...
    function showRemaining() {
        ...
        if (getLanguage === "ko-KR" || getLanguage === "ko-kr" || getLanguage === "ko") {
            document.getElementById(id).textContent = "신청 마감까지 남은 시간 : " + days + "일 ";
            document.getElementById(id).textContent += hours + "시간 ";
            document.getElementById(id).textContent += minutes + "분 ";
            document.getElementById(id).textContent += seconds + "초 ";
        } else if (getLanguage === "ja-JP" || getLanguage === "ja") {
            document.getElementById(id).textContent = "申し込み締め切りまでの残り時間 : " + days + "日 ";
            ...
            document.getElementById(id).textContent = "Time Remaining : " + days + " Day ";
